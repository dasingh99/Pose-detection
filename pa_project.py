...
Original file is located at
    https://colab.research.google.com/drive/10fAZdwCSdWp_mwtrJ9cOC2Ypp8YeM72x
...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    ...
    pdf.cell(200, 10, txt="Your Report",
             ln=1, align='C')
    pdf.set_font("Arial", size=20)
    # add another cell
    pdf.cell(200, 10, txt="",
             ln=2, align='C')
    pdf.cell(200, 10, txt="Bicep Curls",
             ln=2, align='C')
    pdf.set_font("Arial", size=15)
    pdf.cell(200, 10, txt="Name - Dewansh Singh",
             ln=2, align='L')
    pdf.cell(200, 10, txt="Roll - 137",
             ln=2, align='L')

    pdf.cell(200, 10, txt="right: "+str(counter_right)+" Left: "+str(counter_left),
             ln=2, align='C')
